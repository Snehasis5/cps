        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <a
                href="#how-it-works"
                className="text-gray-600 hover:text-blue-600 transition-colors w-24"
              >
                How It Works
              </a>
              <a
              ...
              <div className=" p-3 mt-auto ">
                {isOpen ? (
                  <AuthWrapper isOpen={isOpen} setIsOpen={setIsOpen} />
                ) : (
                  <button
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Ensure student readiness with intelligent formative assessments
              that map prerequisite concepts and identify knowledge gaps before
              progression to new learning objectives.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Advanced AI-powered tools to create meaningful assessments that
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Our four-step process ensures comprehensive prerequisite
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 border border-gray-200">
              <div className="bg-white rounded-xl p-6 shadow-sm">
                ...
                <div className="mt-4 text-xs text-gray-500">
                  Readiness Score: 75% - Review Recursion and Backtracking
                  before proceeding
                </div>
              </div>
            </div>
      ...
      <section id="demo" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Experience how dependency mapping works for different learning
              objectives.
            </p>
          </div>
