...
import { Code, Shield, Lock, Eye, Server, Users, FileText, ArrowLeft } from 'lucide-react';
  ...
  const sections = [
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "We automatically collect information about your use of our platform, including the problems you solve, your learning progress, and your interactions with the learning system."
        },
        {
      ...
      content: [
        {
          ...
          text: "We use your information to provide, maintain, and improve our DSA learning platform, including personalizing your learning experience and tracking your progress."
        },
        {
        ...
        },
        {
          ...
          text: "We analyze usage patterns to enhance user experience and develop new features."
        }
      ]
    },
    {
