      ...
      content: [
        {
          ...
          text: "By accessing or using DSA Tutor, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this platform."
        },
        {
      ...
      content: [
        {
          ...
          text: "All content, features, and functionality of our platform, including but not limited to text, graphics, logos, and software, are owned by DSA Tutor and are protected by intellectual property laws."
        },
        {
      ...
      content: [
        {
          ...
          text: "To the maximum extent permitted by law, DSA Tutor shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the platform."
        },
        {
          subtitle: "Indirect Damages",
          text: "We shall not be liable for any damages arising from the use of our recommendations, learning paths, or any other content provided through our platform."
        }
      ]
    }
  ];
